...
<td><input type="text" class="txtb"  name="pcname" required>
</td>
</tr>
...
switch ($coursetype) {
    ...
    if($femail=="hodit@somaiya.edu")
    {
        ...
        $sql="INSERT INTO addCourse(coursetype,sem,name,id,capacity,IT,addedby,prerequisite,prerequisite_y) VALUES ('$coursetype','$sem','$name','$id','$capacity','1','$femail','$pcname','$cexp')";
    ...
    {
            $sql="INSERT INTO addCourse(coursetype,sem,name,id,capacity,Comps,addedby,prerequisite,prerequisite_y) VALUES ('$coursetype','$sem','$name','$id','$capacity','1','$femail','$pcname','$cexp')";
    ...
    {
            $sql="INSERT INTO addCourse(coursetype,sem,name,id,capacity,ETRX,addedby,prerequisite,prerequisite_y) VALUES ('$coursetype','$sem','$name','$id','$capacity','1','$femail','$pcname','$cexp')";
    ...
    {
            $sql="INSERT INTO addCourse(coursetype,sem,name,id,capacity,EXTC,addedby,prerequisite,prerequisite_y) VALUES ('$coursetype','$sem','$name','$id','$capacity','1','$femail','$pcname','$cexp')";
    ...
    {
            $sql="INSERT INTO addCourse(coursetype,sem,name,id,capacity,Mech,addedby,prerequisite,prerequisite_y) VALUES ('$coursetype','$sem','$name','$id','$capacity','1','$femail','$pcname','$cexp')";
...
$sql="INSERT INTO addCourse(coursetype,sem,name,id,capacity,$qstring addedby,prerequisite,prerequisite_y) VALUES ('$coursetype','$sem','$name','$id','$capacity',$vstring'$femail','$pcname','$cexp')";
        //echo $sql;
        if($conn->query($sql) === TRUE)
   {
...
else
   {
      echo"<script>alert('Failed To Insert');</script>";
        ...
        case 'Open Management':
            ...
            $sql="INSERT INTO addCourse(coursetype,sem,name,id,capacity,IT,Comps,EXTC,ETRX,Mech,addedby,prerequisite,prerequisite_y) VALUES ('$coursetype','$sem','$name','$id','$capacity','1','1','1','1','1','$femail','$pcname','$cexp')";

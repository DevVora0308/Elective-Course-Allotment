...
if ($resultr->num_rows > 0) {
 ...
 $sql = "SELECT name FROM addcourse where sem='".$sem."' AND $branch = '1' AND coursetype='".$coursetype."' AND experience='yes' ";

$result1 = $conn->query($sql);
if ($result1->num_rows > 0) {
echo"Select any one Course<br><br>";
echo"<select name='pref1' onclick='ShowHideDiv()' required>"; 
...
<div id="dvcourse" style="display: none" >
    Do You have an Experience for selected course ?
    <br><br>
...
<div id="yes" style="display:none" >
    <label for="cname">Enter Council Name:</label><br>
...
$sql ="INSERT INTO finalallot2(sid,sem,branch,Ctype,Pref1,councilname,proof) Values('$sid','$sem','$branch','$coursetype','$pref1','$cname','$pname')";
